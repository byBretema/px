...
#define y_fmt std::format /* @danic remove this... use fmtlib or in-house formatter */
...
// clang-format off
#define y_abort_if(cond, msg) if((cond)) { y_err((msg)); std::abort(); }
// clang-format on
//
#define y_assert(...) assert(__VA_ARGS__)
...
public:
    ...
    [[nodiscard]] Str elapsed_str_s() const { return  y_fmt("{} s", elapsed_s()); }
    [[nodiscard]] Str elapsed_str_ms() const { return y_fmt("{} ms", elapsed_ms()); }
    [[nodiscard]] Str elapsed_str_us() const { return y_fmt("{} us", elapsed_us()); }
    [[nodiscard]] Str elapsed_str_ns() const { return y_fmt("{} ns", elapsed_ns()); }

...
if(NEST_CCACHE)
  find_program(_nest_CCACHE ccache)
  if(_nest_CCACHE)
    message(STATUS "ccache: enabled (${_nest_CCACHE})")
    file(MAKE_DIRECTORY "${CMAKE_SOURCE_DIR}/.cache/ccache")
    set(ENV{CCACHE_DIR} "${CMAKE_SOURCE_DIR}/.cache/ccache")
    set(CMAKE_CXX_COMPILER_LAUNCHER "${_nest_CCACHE}")
    set(CMAKE_C_COMPILER_LAUNCHER "${_nest_CCACHE}")
  else()
...
if(NEST_MOLD AND CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux")
  find_program(_nest_MOLD mold)
  if(_nest_MOLD)
    message(STATUS "mold: enabled (${_nest_MOLD})")

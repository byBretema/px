...
if(NEST_CCACHE)
  ...
  if(__nest_g_CCACHE)
    message(STATUS "[nest] · ccache: enabled (${__nest_g_CCACHE})")
    ...
    message(STATUS "[nest] · ccache: not found")
  endif()
endif()
...
if(NEST_MOLD AND CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux")
  ...
  if(__nest_g_MOLD)
    message(STATUS "[nest] · mold: enabled (${__nest_g_MOLD})")
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -fuse-ld=mold")
    set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} -fuse-ld=mold")
    set(CMAKE_MODULE_LINKER_FLAGS "${CMAKE_MODULE_LINKER_FLAGS} -fuse-ld=mold")
  else()
    message(STATUS "[nest] · mold: not found")
  endif()
endif()
